...
const InputField = ({ value, label, icon, name, type, onChange, structure=true, inputWidth=true }) => {

  const struct = structure ? "flex flex-col lg:flex-row lg:gap-5 lg:justify-between lg:items-center" : "flex flex-col";
  ...
  return (
    <div className={`font-medium ${struct} h-full w-full`}>
      ...
      <div className={`${inpWidth} relative mb-4 w-full rounded-lg overflow-hidden`}>
